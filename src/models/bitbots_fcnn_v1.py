...
class FCNNv1LitModel(LightningModule):
    ...
    def validation_epoch_end(self, outputs: List[Any]):
        ...
        self.log("val/acc_3",[0], on_step=False, on_epoch=True, prog_bar=True)
        self.log("val/acc_5", acc[1], on_step=False, on_epoch=True, prog_bar=True)
        self.log("val/acc_10", acc acc[2], on_step=False, on_epoch=True, prog_bar=True)
    ...
    def test_step(self, batch: Any, batch_idx: int):
        ...
        [func.update(arg_pred_x, arg_pred_y, gtcenter_x, gtcenter_y) for func in self.test_radacc]
    ...
    def test_epoch_end(self, outputs: List[Any]):
        acc = [func.compute() for func in self.test_radacc]
